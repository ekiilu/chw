...
describe "community_health_workers/edit" do
  before(:each) do
  ...
  it "renders the edit community_health_worker form" do
    render

    # Run the generator again with the --webrat flag if you want to use webrat matchers
    assert_select "form", :action => community_health_workers_path(@community_health_worker), :method => "post" do
